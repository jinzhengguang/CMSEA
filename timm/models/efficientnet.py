...
default_cfgs = {
    ...
    'tf_efficientnetv2_s': _cfg(
        ...
        mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5),
        input_size=(3, 448, 448), test_input_size=(3, 448, 448), pool_size=(10, 10), crop_pct=1.0),
    'tf_efficientnetv2_m': _cfg(
        ...
        mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5),
        input_size=(3, 448, 448), test_input_size=(3, 448, 448), pool_size=(12, 12), crop_pct=1.0),
